...
namespace it.Areas.Admin.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewData["donvi"] = _context.DonviModel.Select(a => new SelectListItem()
            {
                Value = a.MACH,
                Text = a.TEN
            }).ToList();
        ...
        [HttpPost]
        public async Task<IActionResult> Create(UserModel User, string password, List<string> groups)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(string id, UserModel User, List<string> groups)
        {
            //return Ok(User);
            if (id != User.Id)
            {
